...
# Diebold-Mariano test to see if forecasts are significantly different

dm.test(error.model.110.garch.11$p80h12, error.model.010.garch.11$p80h12, h=12, power=1)
dm.test(error.model.110.garch.11$p80h12, error.model.010.garch.21$p80h12, h=12, power=1)
